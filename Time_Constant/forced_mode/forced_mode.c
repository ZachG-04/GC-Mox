...
#define HEATER_TEMP      250                // heater temp
#define HEATER_DUR_MS   100
#define SAMPLE_MS    200                // ms between samples
...
int main(void)
{
//    struct bme69x_dev bme; // for 1 device just this
  
    struct bme69x_dev bme1, bme2; // for 2 device this
    int8_t rslt;
    ...
    // Heater config: single constant setting 
    ...
    // header 
    printf("t_ms,gas_ohm,temp_C,hum_pct,press_Pa,status\n");
    fflush(stdout);
